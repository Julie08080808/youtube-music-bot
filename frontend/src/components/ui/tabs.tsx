...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "relative inline-flex h-10 items-center justify-center rounded-md bg-gray-100 dark:bg-gray-800 p-1 text-gray-500 dark:text-gray-400",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Tab
    ...
    className={cn(
      ...
      "dark:data-[selected]:bg-gray-950 dark:data-[selected]:text-gray-50",
      className,
    )}
    {...props}
  />
